  ...
  return (
    <div className="foodBuilder__ingredientButton">
      ...
      <div className="foodBuilder__ingredientButton__buttonContainer">
        ...
        {/* button name */}
        <h4 className="foodBuilder__ingredientButton__buttonContainer__name">Salate</h4>
        {/* button description */}
        ...
        {/* button price */}
        <h4 className="foodBuilder__ingredientButton__buttonContainer__price">180 <span style={{fontSize:"0.5em"}}>din</span></h4>
        </div>
      </div>
    </div>
  )
